...
export function SafeDoor({active, vault, ...props}:
    ...
    return <group {...props} dispose={null}>
        {active ? <CodeScreen screenMesh={nodes.Screen} code={code}/>
...
function CodeScreen({screenMesh, code}: {screenMesh: THREE.Mesh, code: string}) {
